...
const SYSTEM_INSTRUCTIONS = {
  study:
    "あなたは資格試験の学習をサポートするプロ講師です。親切な挨拶や前置きは一切省き、ユーザーの質問に対して3〜4行の簡潔な解説、または3つ以内の短い箇条書きでズバッと回答してください。",
  casual:
    "あなたは資格試験の勉強を頑張るユーザーを応援する、気さくで優しいAIの先輩（または学習パートナー）です。専門的な解説は控えめにし、ユーザーの愚痴を聞いたり、モチベーションを高める楽しい雑談相手になってあげてください。日本語はフランクで親しみやすい口調にしてください。",
};
...
export default function Chat({}: ChatScreenProps): React.ReactElement {
  ...
  const [noteItemType, setNoteItemType] =
    useState<NoteMetadata["item_type"]>("term");
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      try {
        ...
        alert(
          `AI応答の生成に失敗しました: ${aiErr?.message || "不明なエラー"}`,
        );
      } finally {
        setAiThinking(false);
      }
      ...
      <View style={styles.toggleWrap}>
        <View style={styles.toggleInner}>
          <Pressable
            style={[
              styles.toggleButton,
              mode === "study" && styles.toggleActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.toggleText,
                mode === "study" && styles.toggleTextActive,
              ]}
            >
              📝 学習
            </Text>
          ...
          <Pressable
            style={[
              styles.toggleButton,
              mode === "casual" && styles.toggleActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.toggleText,
                mode === "casual" && styles.toggleTextActive,
              ]}
            >
              💬 雑談
            </Text>
                ...
                return (
                  <View key={msg.id} style={styles.aiRow}>
                    ...
                    <Pressable
                      style={[
                        styles.saveButton,
                        analyzingNote && styles.saveButtonDisabled,
                      ]}
      ...
      >
        <View style={styles.footer}>
          ...
          <Pressable
            style={[
              styles.sendButton,
              (sending || aiThinking) && styles.sendButtonDisabled,
            ]}
          ...
          <View style={styles.modalContainer}>
            ...
            <ScrollView style={styles.modalContent}>
              ...
              <View style={styles.typeSelector}>
                <Pressable
                  style={[
                    styles.typeButton,
                    noteItemType === "term" && styles.typeButtonActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      ...
                      noteItemType === "term" && styles.typeButtonTextActive,
                    ]}
                  >
                    📖 用語
                  </Text>
                ...
                <Pressable
                  style={[
                    styles.typeButton,
                    noteItemType === "memo" && styles.typeButtonActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.typeButtonText,
                      noteItemType === "memo" && styles.typeButtonTextActive,
                    ]}
                  >
                    📝 メモ
                  </Text>
                ...
                <Pressable
                  style={[
                    styles.typeButton,
                    noteItemType === "question" && styles.typeButtonActive,
                  ]}
            ...
            <View style={styles.modalFooter}>
              ...
              <Pressable
                ...
                disabled={
                  savingNote || !noteTitle.trim() || !selectedAiResponse.trim()
                }
